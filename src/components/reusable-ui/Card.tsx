...
import { Chips } from "../pages/order/Main/MainProducts/CatalogProducts/Chips"
...
const CardStyled = styled.div<CardStyledProps>`
	...
	.card {
		...
		border-radius: ${({ areChipsVisible }) => areChipsVisible === false && theme.borderRadius.extraRound};
			...
			.description {
				...
				.left-description {
					...
					.old-price {
						...
						color: ${({ isSelected }) => (isSelected ? theme.colors.white : theme.colors.redSecondary)};
